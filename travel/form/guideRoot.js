...
window.parent.getConfig(function (conf) {
    ...
    (function () {
        ...
        var travelLogin = function () {
            ...
            // Remove session storage nullHandling for hiding the error message generated by previous null clientData.
            sessionStorage.removeItem('nullHandling');
            $('.clientInfoFailMsg .guideFieldError').html('');
